...
class objectDetection:
    ...
    def model_setup(self):
        ...
        if self.modelPath == None or self.modelPath == "":
            ...
            if not os.path.isfile(self.modelPath) or not os.access(self.modelPath, os.R_OK):
        ...
        if self.labelMapPath == None or self.labelMapPath == "":
            ...
            if not os.path.isfile(self.labelMapPath) or not os.access(self.labelMapPath, os.R_OK):
                raise Exception("Model file doesn't exist or is unreadable!")
