...
class objectDetection:
    ...
    def model_setup(self):
        ...
        if self.labelMapPath is None or \
           self.labelMapPath == "":
            # List of the strings
            # that is used to add correct label for each box.
        ...
        with detection_graph.as_default():
            with tf.Session(graph=detection_graph) as sess:
                ...
                while True:
                    ...
                    # if input is an image, just return the detected version
                    # once it comes back from the tensorflow graph
                    if imgflag is True:
                        ...
                        # Quit detection if user interrupts it
