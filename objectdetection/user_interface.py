...
class ObjectDetection_ui(tk.Tk):
    ...
    def main(self):
        ...
        self.model_path.bind("<Button-1>", lambda event,
                             arg=self.model_path: self.delete_placeholder(arg))

        # browse for a model
        self.model_input = Button(self.modelGroup, text="Browse",
                                  command=lambda: self.askmodelfile(self.model_path))
        ...
        self.label_path.bind("<Button-1>", lambda event,
                             arg=self.label_path: self.delete_placeholder(arg))
